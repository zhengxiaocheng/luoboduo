...
/***/ function(module, exports) {
	...
	var notImplemented = function (fnname) { return function () {
	    throw new Error(fnname + "(): No coreservices implementation for UI-Router is loaded. You should include one of: ['angular1.framework']");
	}; };
	var services = {
	    $q: undefined,
	    $injector: undefined,
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * <views ng-app="myApp">
	 * <head>
	 *   <script src="framework/angular.framework"></script>
	 *   <!-- Include the ui-router script -->
	 *   <script src="framework/angular-ui-router.min.framework"></script>
	 *   <script>
	...
	function $uiRouter($locationProvider) {
	    ...
	    function $get($location, $browser, $sniffer, $rootScope, $http, $templateCache) {
	        ...
	        coreservices_1.services.template.get = function (url) {
	            return $http.get(url, { cache: $templateCache, headers: { Accept: 'text/views' } }).then(hof_1.prop("data"));
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TemplateFactory = (function () {
	     ...
	     *
	     * @return {string|object}  The template views as a string, or a promise for
	     ...
	     *
	     * @param template views template as a string or function that returns an views template as a string.
	     * @param params Parameters to pass to the template function.
	     *
	     * @return {string|object} The template views as a string, or a promise for that
	     * string.
	     */
	     ...
	     * @return {string|Promise.<string>} The template views as a string, or a promise
	     * for that string.
	     */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StateProvider = (function () {
	     ...
	     *     config.templateUrl = config.templateUrl || '/partials/' + autoName + '.views';
	     *     result[name] = config;
	     *   });
	     *   return result;
	     * });
	     ...
	     *
	     * $state.go('home');
	     * // Auto-populates list and item views with /partials/home/contact/list.views,
	     * // and /partials/home/contact/item.views, respectively.
	     * </pre>
	     *
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * ```
	 *
	 * Then the compiled views would be (assuming Html5Mode is off and current state is contacts):
	 *
	 * ```views
	 *
	 * <pre>
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * ```
	 *
	 * You can only have one unnamed view within any template (or root views). If you are only using a
...
;
//# sourceMappingURL=angular-ui-router.framework.map